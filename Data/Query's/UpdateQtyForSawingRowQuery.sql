...
DECLARE @QuantityNew INT = {QuantityNew};
...
BEGIN TRY
    ...
    SET @ResultCode = 1;
    SET @ResultMessage = 'Zaag aantal succesvol aangepast voor PD ' + @ProdHeaderDossierCode + ', regel ' + CAST(@ProdBOOLineNr AS NVARCHAR);
    COMMIT TRANSACTION;
END TRY
BEGIN CATCH
    SET @ResultCode = 0;
