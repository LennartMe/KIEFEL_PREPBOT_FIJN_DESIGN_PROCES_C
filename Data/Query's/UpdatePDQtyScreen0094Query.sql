...
BEGIN TRY
	...
	EXEC sp_executesql N'execute IP_sel_ProdBOMNC_CalcFields 
		@ProdHeaderDossierCode = @P1 
		, @ProdBOMLineNr = @P2 
		, @InclWaste = @P3',N'@P1 nvarchar(4000),@P2 int,@P3 bit',@HeadProductionDossiercode,----HeadPD of PD to recalculate
		@PBLineNr,--ProdBomLineNr
		1
	...
	EXEC dbo.SIP_upd_MaterialsList
		...
		@ProdBOMLineNr = @PBLineNr, --ProdBomLineNr
		@Qty = @NewQty,	--New Quantity
		@NetQty = @NewQty, --New Quantity
    ...
    SET @ResultCode = 1
    SET @ResultMessage = 'quantity ProductionDossiercode '+ @ProductionDossiercode + ' successfully updated to ' + @NewQty + ' in screen 0094'
	COMMIT TRANSACTION
END TRY
BEGIN CATCH
