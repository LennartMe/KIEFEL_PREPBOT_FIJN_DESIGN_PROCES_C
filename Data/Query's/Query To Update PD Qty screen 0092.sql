...
BEGIN TRY
    exec [dbo].[IP_Upd_ProdHeader] 
		...
		NULL,NULL,NULL,NULL,NULL,@QuantityNew,--New Quantity
    ...
    SET @ResultCode = 1
    SET @ResultMessage = 'quantity ProductionDossiercode '+ @ProductionDossiercode + ' successfully updated to ' + @QuantityNew + ' in screen 0092'
	COMMIT TRANSACTION
END TRY
BEGIN CATCH
